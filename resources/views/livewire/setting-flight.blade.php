<div>
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Setting Flight</h4>
        ...
        <div class="row">
          <div class="col-md-3">
            <label for="fname" class="col-form-label">Flight Name:</label>
            <input type="text" class="form-control text-black" id="fname" wire:model="fname" placeholder="Write flight name here">
          </div>
        </div>
        @endif
        @if($action != 'add')
                        ...
                        <tbody>
                          @if(($listFlight!=null)&&(count($listFlight)>0))
                           @foreach($listFlight as $val)
                            ...
                            <td class="text-center">{{$val->flightName}}</td>
